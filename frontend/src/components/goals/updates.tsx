    ...
    stories: [
      {
        ...
        backgroundColor: "bg-gradient-to-br from-primary to-primary/60",
  ...
  },
  {
    ...
    stories: [
      ...
      },
      {
        id: "2-2",
        type: "text",
        content: "Working on my fitness goals! 💪 Day 15 of 30",
    ...
    stories: [
      {
        id: "3-1",
        type: "text",
        content: "📚 Finished reading 5 books this month!",
    ...
    stories: [
      {
        id: "5-1",
        type: "text",
        content: "🚀 Launched my side project today!",
